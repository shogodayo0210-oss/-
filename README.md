...
$ python3 game/tools/balance.py                   # 試合そのものを測る（12.4）
...
$ python3 -m unittest discover -s game/tests -t . # 40件
```
...
まだ仮定なのは、レーン数（1本）・戦闘の長さ（5分）・拠点HP（10000）・
...
| 遠距離（単体） | `[0, 72]` | 死角なしで遠くまで。そのぶん貫通1・体力低め |
...
| --- | --- | ---: | ---: | --- |
| **軽** | 1〜2 | 18秒 | 3 | 士気1・早撃ち1・猛攻1・動揺1・錆2・脆化2・増税2 |
| **中** | 3〜5 | 20〜22秒 | 2 | 腐食3・氷結3・徴発3・断絶3・鬨の声4・決死4・鈍化4・進軍4・泥濘4・大盤振る舞い4・封鎖4・枯渇4・背水4・反攻4・死守4・疾駆5・混乱5・踏ん張り5・増収5 |
| **重** | 8〜10 | 24秒 | 1 | 停滞8・号令8・総動員9・不退転9・金脈9・分断10・堅陣10 |
...
- *中盤（50%時点）に押されていた側が一度も勝っていない*（0/10）。前半で
  決まりきっている。押し込まれてから開く札（5.4）は入れたが、まだ届いていない。
- *rush（育てない方針）が balanced・greed に 0% で負ける。* 陣地ボーナスを
