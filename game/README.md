...
**上限が低いうちは、高いユニットが物理的に出せない。**
巨兵（600）はLv3から、切り札（800）はLv4から。
つまり序盤は「安いユニットで押すか、黙って育てるか」を選ぶことになる。
...
- **択が3つになった問題。** 出す／育てる／貯めて大技、が同時に走る。
  厚みは出たが、初見には多いかもしれない。**最初の数試合だけ成長を
  自動にする**などの導入が要るかもしれない。
