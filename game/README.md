...
- **育てる側が強すぎる（12.2）。** 安い壁の連鎖で前線が保たれてしまい、
  攻めても成長を止められない。壁の体力を下げるか、レベルアップの隙を
  伸ばすか、資金の伸びを鈍くするか。まだどれも試していない。
...
3つの方針（rush＝Lv2で殴り続ける / balanced＝Lv4 / greed＝Lv6まで育てる）の
総当たり。各20試合、勝ち1・引き分け0.5で採点。

| 行＼列 | balanced | greed | rush |
| --- | ---: | ---: | ---: |
| **balanced** | 54% | 0% | 100% |
| **greed** | 100% | 25% | 100% |
| **rush** | 0% | 0% | 50% |

**greed > balanced > rush** がはっきり出ている。3秒の隙を作ってもなお、
育てる側が有利。理由は**安い壁の連鎖**で、兵卒（60）を出し続けるだけで
前線が保たれ、育てている側は殴られない。

つまり 4.3 に書いた「兵卒で殴りに行くだけで相手の成長を止められる」は
**この数字では成り立っていない**。直すなら、壁の費用対効果を下げる
（安いユニットの体力を落とす）か、レベルアップの隙を伸ばすか、
資金の伸びを鈍くするか。まだどれも試していない。

なお方針の側はかなり粗い（「壁が2体未満なら最安、それ以外は最も高いものを出す」
程度）ので、上手い rush ならもっとやれる可能性は残っている。
