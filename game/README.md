...
| ユニット | T | 資金 | CD | 体力 | 攻撃力 | 間隔 | 発生 | 攻撃範囲 | 貫通 | KB | 速度 | 対拠点 | 対壁 |
| --- | :-: | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 兵卒 | B | 60 | 3s | 400 | **35** | 1.2s | 0.15s | `[0,12]` | 1 | 1 | 8 | **0.5** | 1.0 |
| 槍兵 | B | 120 | 5s | 700 | 110 | 1.4s | 0.20s | `[0,25]` | 1 | 3 | 7 | 1.0 | 1.3 |
| 弓手 | A | 200 | 8s | 450 | 130 | 1.7s | 0.30s | `[0,90]` | 1 | 2 | 4 | 0.8 | 1.0 |
| 重装 | A | 260 | 10s | 3000 | **45** | 2.0s | 0.25s | `[0,14]` | 1 | **1** | 4 | **0.5** | 1.0 |
| 双剣 | A | 300 | 12s | 900 | 200 | 0.8s | 0.10s | `[0,13]` | 1 | **4** | 9 | 1.2 | **1.8** |
| 薙ぎ払い | A | 340 | 14s | 1200 | 180 | 2.0s | 0.40s | `[0,45]` | **6** | 3 | 5 | 0.7 | **2.2** |
| 臼砲 | S | 400 | 16s | 500 | 480 | 3.2s | 0.80s | `[70,150]` | **8** | 2 | 3 | **1.5** | 0.6 |
| 砲手 | S | 420 | 18s | 600 | 480 | 3.5s | 0.70s | `[0,130]` | 5 | 3 | 3 | 1.0 | 1.0 |
| 巨兵 | S | 600 | 25s | 6000 | 350 | 2.4s | 0.60s | `[0,20]` | 3 | 2 | 3 | 1.3 | 1.5 |

太字が壁まわりの調整。**兵卒と重装が壁**（対拠点0.5＝拠点を割れない）で、
攻撃力も低い。**薙ぎ払いと双剣がその答え**で、壁にだけ 2.2倍／1.8倍が乗る。
臼砲の対壁0.6は逆に「壁には効かない後方兵器」を意味する。
